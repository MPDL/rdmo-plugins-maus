...
class MultivalueCheckboxMultipleChoiceField(forms.MultipleChoiceField):
    ...
    def __init__(self, *, include_select_all_choice=False, sortable=False, choice_validators=None, **kwargs):
        ...
        :param dict[str, dict['checkbox'|'text', list[validators]]] choice_validators:
    ...
    def to_python(self, value):
        ...
        return [','.join(x.strip() for x in multival.split(',')) for multival in value]
    ...
    def clean(self, value):
        ...
        for multivalue in value:
            ...
            if choice_key in self.choice_keys:
                ...
                _out, errors = choice_field.clean(choice_value)
                if len(errors) > 0:
